...
class GenerativeAISample extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ChatScreen(title: 'Jarvis AI'),
    );
  }
}
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ChatWidget(apiKey: 'AIzaSyBz1-CTWzxWv6rMESZfL-4y_je1caU-Pes'),
    );
  }
}
...
class _ChatWidgetState extends State<ChatWidget> {
  ...
  Future<void> _sendChatMessage(String message) async {
    ...
    final currentDiscussionId = Provider.of<CurrentDiscussionIdProvider>(context, listen: false).currentDiscussionId;
    final discussionProvider =
            Provider.of<DiscussionProvider>(context, listen: false);
    discussionProvider.addMessageToDiscussion(
            currentDiscussionId as String, message, true);
    try {
      ...
      if (text == null) {
        ...
        final discussionProvider =
            Provider.of<DiscussionProvider>(context, listen: false);
        discussionProvider.addMessageToDiscussion(
            currentDiscussionId as String, text, false);
        setState(() {
          _loading = false;
          _scrollDown();
        });
...
extension CustomColorScheme on ColorScheme {
  Color get surfaceContainerHighest => Color.fromARGB(255, 86, 149, 126); // Exemple de couleur
}
